...
public class RemoveDuplicates {
	...
	// Method-2
	private static void removeDuplicatesUsingHashSet(int[] inputArray)
	{
		HashSet<Integer> set = new HashSet<Integer>();
		for (int element : inputArray)
		{
			if(set.add(element))   // if( !set.add(element))  -- find duplicate 
				System.out.println("Remove Duplicate Element : "+element);
	...
	{       
		...
		removeDuplicatesUsingHashSet( new int[] {4, 3, 2, 4, 9, 2});
	}   
}
